...
export default function LandingHero() {
  ...
  return (
    <section ref={ref} className="relative min-h-[100svh] overflow-hidden">
      <div className="absolute inset-0 -z-20 bg-[radial-gradient(circle_at_50%_15%,rgba(242,216,177,0.65),transparent_35%),radial-gradient(circle_at_85%_18%,rgba(140,170,216,0.24),transparent_35%)]" />

      <div className="absolute inset-0 -z-10 flex items-center justify-center">
        <motion.div style={{ y: visualY }} className="relative h-[72vh] w-[92vw] max-w-[1150px] overflow-hidden rounded-[2.4rem] border border-border/60">
          <img
            src="https://images.unsplash.com/photo-1516321318423-f06f85e504b3?auto=format&fit=crop&w=1800&q=80"
            alt="Nexora cinematic preview"
            className="h-full w-full object-cover"
          />
          <div className="absolute inset-0 bg-[linear-gradient(180deg,rgba(14,10,8,0.12),rgba(14,10,8,0.6))]" />
        </motion.div>
      </div>
      ...
      <div className="absolute inset-0 z-10 flex min-h-[100svh] items-center justify-center px-4">
        <motion.div style={{ y: titleY }} className="mx-auto max-w-5xl text-center">
          <motion.div
            ...
            className="mx-auto mb-6 inline-flex items-center gap-2 rounded-full border border-border bg-card/88 px-4 py-2 text-caption shadow-sm"
          >
          ...
          <motion.h1
            ...
            className="text-balance font-semibold tracking-[-0.06em] text-[clamp(4.2rem,15vw,10rem)] leading-[0.82]"
          >
            NEXORA
          </motion.h1>
          ...
          <motion.p
            ...
            className="mx-auto mt-6 max-w-3xl text-body-lg text-foreground/80"
          >
